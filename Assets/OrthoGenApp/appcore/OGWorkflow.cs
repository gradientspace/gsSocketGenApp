...
namespace orthogen
{
    ...
    public static class OGWorkflow
    {
        ...
        public static string TrimScanAcceptWaitState = "TrimScanWaitAccept";
        public static string TrimScanStartT = "Trim_Start";
        public static string TrimScanBeginAcceptT = "Trim_BeginAccept";
        public static string TrimScanCompleteAcceptT = "Trim_CompleteAccept";
        ...
        public static string BendScanState = "BendScan";
        public static string BendScanStartT = "BendScan_Start";
        public static string BendScanAcceptT = "BendScan_Accept";
        public static string BendScanCancelT = "BendScan_Cancel";

        public const string ScanSmoothBrushState = "ScanSmoothBrush";
        public const string ScanSmoothBrushStartT = "ScanSmoothBrush_Start";
        public const string ScanSmoothBrushExitT = "ScanSmoothBrush_Exit";
        ...
        public static string AddLegSqueezeState = "LegSqueeze";
        public static string AddLegSqueezeStartT = "LegSqueeze_Start";
        public static string AddLegSqueezeAcceptT = "LegSqueeze_Accept";
        public static string AddLegSqueezeCancelT = "LegSqueeze_Cancel";
        ...
        public const string SculptRegionState = "SculptRegion";
        public const string SculptRegionStartT = "SculptRegion_Start";
        public const string SculptRegionExitT = "SculptRegion_Exit";

        public const string SculptGlobalMapState = "SculptGlobalMap";
        public const string SculptGlobalMapStartT = "SculptGlobalMap_Start";
        public const string SculptGlobalMapExitT = "SculptGlobalMap_Exit";
