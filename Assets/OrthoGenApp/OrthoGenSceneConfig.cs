...
public class OrthoGenSceneConfig : BaseSceneConfig
{
    ...
    public override void Awake()
    {
        ...
        //string sampleFile = Path.Combine(samplesPath, "scan_1_orig.obj");
        //string sampleFile = Path.Combine(samplesPath, "scan_1_raw_cleaned.obj");
        //string sampleFile = Path.Combine(samplesPath, "scan_1_remesh.obj");
        //string sampleFile = Path.Combine(samplesPath, "local\\scan_3.obj");
        //string sampleFile = "C:\\Users\\rms\\Downloads\\scan_2017-04-05-11-27-32.obj";
